let status = JSON.parse(localStorage.getItem('status')) || {
        ...
        function playGame(playerMove) {
            ...
            <img src="../rock-paper-scisssor game/images/${playerMove}-emoji.png" alt="rock-emoji" class="move-icon">
            
            <img src="../rock-paper-scisssor game/images/${computerMove}-emoji.png" alt="rock-emoji" class="move-icon">COMPUTER
             `;
